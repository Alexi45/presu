...
export const GUIAS: Guia[] = [
  {
    ...
    titulo: "IVA en reformas: cuándo es el 10 % y cuándo el 21 % | Presu",
    descripcion:
  ...
  },
  {
    ...
    titulo: "Retención de IRPF: cuándo se aplica y cuánto | Presu",
    descripcion:
  ...
  },
  {
    ...
    titulo: "Cómo hacer un presupuesto profesional paso a paso | Presu",
    descripcion:
    ...
    secciones: [
      ...
      },
      {
        ...
        parrafos: [
          ...
          "Es la razón de que exista Presu: si el presupuesto se puede terminar y enviar desde el móvil antes de salir de casa del cliente, el trabajo ya es casi tuyo.",
        ],
      },
    ],
    faq: [
      ...
      },
      {
        ...
        respuesta:
          "No. El presupuesto es una oferta de precio y no tiene efectos fiscales. La factura documenta una operación ya realizada y está sujeta a la normativa de facturación. Presu genera presupuestos, no facturas.",
      },
    ],
