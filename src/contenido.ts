...
export const CLAVES = [
  ...
  },
  {
    ...
    texto:
      "Si mezclas partidas al 21 % y al 10 %, el desglose tiene que aparecer por separado. Presu lo agrupa y lo calcula solo.",
  },
  {
  ...
  },
  {
    ...
    texto:
      "Un presupuesto firmado es la mejor prueba de lo acordado. Todos los que genera Presu llevan el bloque de aceptación al final.",
  },
];
