 ...
 *
 * Son plantillas redactadas para el caso concreto de PresupPRO (producto digital,
...
export const LEGALES = [
  {
    slug: "aviso-legal",
    titulo: "Aviso legal | PresupPRO",
    h1: "Aviso legal",
    descripcion:
      "Información sobre el titular del sitio web PresupPRO, condiciones de uso y propiedad intelectual.",
    cuerpo: `
...
<h2>Objeto</h2>
<p>PresupPRO es una herramienta que permite elaborar documentos de presupuesto y descargarlos en formato PDF. El uso de la herramienta es libre y no requiere registro. Determinadas funciones están sujetas a pago según se detalla en las <a href="/condiciones/">condiciones de contratación</a>.</p>
...
`,
  ...
  {
    slug: "privacidad",
    titulo: "Política de privacidad | PresupPRO",
    h1: "Política de privacidad",
    descripcion:
      "Qué datos trata PresupPRO, dónde se guardan los presupuestos y cuáles son tus derechos.",
    cuerpo: `
<p>Esta política explica cómo se tratan los datos personales en PresupPRO. La versión corta: <strong>los presupuestos que elaboras no salen de tu navegador, salvo cuando compras la descarga sin marca de agua</strong>, que se genera en nuestro servidor y para eso necesita el contenido del documento.</p>
...
`,
  ...
  {
    slug: "condiciones",
    titulo: "Condiciones de contratación | PresupPRO",
    h1: "Condiciones de contratación",
    descripcion:
      "Precios, forma de pago, entrega y derecho de desistimiento de los productos de pago de PresupPRO.",
    cuerpo: `
<p>Estas condiciones regulan la contratación de los productos de pago de PresupPRO. Elaborar y previsualizar presupuestos es gratuito y no requiere aceptar estas condiciones.</p>
